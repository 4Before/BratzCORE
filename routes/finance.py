    ...
    try:
        ...
        with db.session.begin_nested():
            ...
            for item_data in payload.items:
                # Lógica de atualização de estoque (implementação otimista)
                ...
                if result.rowcount == 0:
                    raise Exception(f"Estoque insuficiente para o produto ID {item_data.product_id}.")
...
@finances_bp.route('/sells', methods=['GET'])
@auth_utils.token_required
...
@finances_bp.route('/specific/<string:cashier_id>/sells', methods=['GET'])
@auth_utils.token_required
...
@finances_bp.route('/summary/daily', methods=['GET'])
@auth_utils.token_required
...
@finances_bp.route('/summary/monthly', methods=['GET'])
@auth_utils.token_required
@auth_utils.privilege_required("FINANCE")
...
@finances_bp.route('/reports/sales-flow', methods=['GET'])
@auth_utils.token_required
@auth_utils.privilege_required("FINANCE")
...
@finances_bp.route('/reports/payment-methods', methods=['GET'])
@auth_utils.token_required
@auth_utils.privilege_required("FINANCE")
...
@finances_bp.route('/reports/profit-margin', methods=['GET'])
@auth_utils.token_required
@auth_utils.privilege_required("FINANCE")
